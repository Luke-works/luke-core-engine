...
--
-- This is an EXACT, idempotent copy of V1__baseline_luke_tables.sql (every statement is "… if not
-- exists"): a no-op where the tables already exist (dev/prod, fresh baseline@0), self-healing where they
-- don't (a Camunda-only schema baselined past V1). Keep it in sync with V1 — both are frozen baselines;
-- new schema changes go in NEW V8+ migrations, never by editing V1 / this file.
--
